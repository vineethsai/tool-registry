...
class AccessLog(Base):
    ...
    log_id = Column(PUUID(as_uuid=True), primary_key=True)
    ...
    policy_id = Column(PUUID(as_uuid=True), ForeignKey('policies.policy_id'), nullable=True)
    credential_id = Column(PUUID(as_uuid=True), ForeignKey('credentials.credential_id'), nullable=True)
